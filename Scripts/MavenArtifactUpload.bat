...
@echo Example Usage:
@echo D:\Scripts\Maven\MavenArtifactUpload.bat D:\work\gitconvert\my-utils-1.0..pom.xml D:\work\gitconvert\my-utils-1.0..jar MyCompany "https://pkgs.dev.azure.com/MyCompany/_packaging/MyCompany/maven/v1"
